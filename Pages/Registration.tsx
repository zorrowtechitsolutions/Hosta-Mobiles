...
import { CheckSquare, Square } from "lucide-react-native"; // icons for checkbox
    ...
    >
      ...
      >
        <View style={styles.form}>
          ...
          >
            {acceptedTerms ? (
              <CheckSquare size={20} color="#66BB6A" />
            ) : (
              <Square size={20} color="#66BB6A" />
            )}
            <Text style={styles.checkboxText}>
              I accept the{" "}
              <Text style={styles.linkText}  onPress={() => Linking.openURL("https://zorrowtechitsolutions.github.io/Hosta-Privacy-Policy")}>Privacy Policy</Text>
            </Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            style={[
              styles.button,
              !acceptedTerms && { backgroundColor: "#A5D6A7" },
            ]}
